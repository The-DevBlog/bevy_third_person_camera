...
///                aim_button: GamepadButton::new(gamepad, GamepadButton::LeftTrigger2),
///                mouse_orbit_button: GamepadButton::new(gamepad, GamepadButton::LeftTrigger),
///                offset_toggle_button: GamepadButton::new(gamepad, GamepadButton::DPadRight),
///                x_sensitivity: 7.0,
///                y_sensitivity: 4.0,
///                zoom_in_button: GamepadButton::new(gamepad, GamepadButton::DPadUp),
///                zoom_out_button: GamepadButton::new(gamepad, GamepadButton::DPadDown),
///            },
///            ..default()
///        },
...
fn sync_player_camera(
    player: Single<&Transform, With<ThirdPersonCameraTarget>>,
    cam: Single<(&mut ThirdPersonCamera, &mut Transform), Without<ThirdPersonCameraTarget>>,
) {
    let (cam, mut cam_transform) = cam.into_inner();
...
fn aim_condition(cam: Single<&ThirdPersonCamera, With<ThirdPersonCamera>>) -> bool {
    cam.aim_enabled
}
...
fn aim(
    ...
    mut player_transform: Single<&mut Transform, With<ThirdPersonCameraTarget>>,
    gamepad: Option<Single<&Gamepad>>,
    time: Res<Time>,
) {
    let (mut cam, cam_transform) = cam_q.into_inner();
...
pub fn zoom_condition(cam: Single<&ThirdPersonCamera, With<ThirdPersonCamera>>) -> bool {
...
fn toggle_cursor(
    cam: Single<&mut ThirdPersonCamera>,
...
fn toggle_cursor_condition(cam: Single<&ThirdPersonCamera>) -> bool {
